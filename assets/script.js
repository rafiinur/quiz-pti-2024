const article = [
  {
    ...
    slug: "joselu-pemain-real-madrid-yang-mengalami-transformasi-luar-biasa",
    content:
  ...
  {
    title: "Penundaan Grand Prix Kazakhstan MotoGP 2024",
    slug: "penundaan-grand-prix-kazakhstan-motogp-2024",
    content:
...
article.forEach((item) => {
  ...
  cardImage.src = `assets/img/${item.image}`
  cardImage.alt = `${item.title} Image`
  cardImage.quality = 95
  ...
  cardDate.textContent = `Admin | ${item.date} | ${item.time} WIB`

  badgesDiv.appendChild(categoryBadge)
  cardInfo.appendChild(cardTitle)
  cardInfo.appendChild(badgesDiv)
